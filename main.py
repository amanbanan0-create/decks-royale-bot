...
async def build_deck_image(
    ...
    for idx, card in enumerate(normalized):
        ...
        # Unified Clash Royale-style frame for every card
        ...
        if icon_bytes:
            try:
                ...
                art_w = max(1, art_x2 - art_x1)
                art_h = max(1, art_y2 - art_y1)

                # Make all cards fill the portrait area similarly to Minion Giant.
                icon = ImageOps.fit(
                    icon,
                    (art_w, art_h),
