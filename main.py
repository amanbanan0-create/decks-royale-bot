...
async def get_card_image_bytes(raw_card) -> bytes | None:
        ...
        async with httpx.AsyncClient(
            ...
            for index, url in enumerate(candidates, 1):
                ...
                if retry_after is not None:
                    if retry_after > now:
                        # Known temporary 404/bad asset; skip quietly.
                        continue
                    # Cooldown expired — Supercell CDN gets another chance.
                ...
                try:
                    ...
                    if response.status_code == 404:
                        ...
                        # 404 from a newly-published/stale asset is not a bot error.
                        # Log it at INFO instead of WARNING/ERROR.
                        logging.info(
                    ...
                    # Network errors are transient; do not negative-cache them.
                    logging.info(
    ...
    # No red/yellow warning: the renderer deliberately supports placeholders.
    if card_name not in card_image_placeholder_logged:
        logging.info(
